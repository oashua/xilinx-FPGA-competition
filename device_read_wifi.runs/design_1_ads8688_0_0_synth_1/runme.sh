...
HD_PWD='D:/xilinx/project/device_read_wifi/device_read_wifi.runs/design_1_ads8688_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_ads8688_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_ads8688_0_0.tcl
