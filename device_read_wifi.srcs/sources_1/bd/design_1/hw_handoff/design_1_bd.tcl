...
proc create_root_design { parentCell } {
  ...
  set wifi [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:uart_rtl:1.0 wifi ]

  # Create ports
  set CS_0 [ create_bd_port -dir O CS_0 ]
  set CTL [ create_bd_port -dir O -from 2 -to 0 CTL ]
  set RST_0 [ create_bd_port -dir O -type rst RST_0 ]
  set SCLK_0 [ create_bd_port -dir O SCLK_0 ]
  set SDI_0 [ create_bd_port -dir O SDI_0 ]
  set SDO_0 [ create_bd_port -dir I SDO_0 ]
  set zero [ create_bd_port -dir I -from 0 -to 0 zero ]

  # Create instance: ads8688_0, and set properties
  set ads8688_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:ads8688:1.0 ads8688_0 ]
  ...
  connect_bd_intf_net -intf_net axi_gpio_2_GPIO [get_bd_intf_ports SW] [get_bd_intf_pins axi_gpio_2/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_2_GPIO2 [get_bd_intf_ports btns_4bits] [get_bd_intf_pins axi_gpio_2/GPIO2]
  connect_bd_intf_net -intf_net axi_uartlite_0_UART [get_bd_intf_ports wifi] [get_bd_intf_pins axi_uartlite_0/UART]
  ...
  connect_bd_net -net SDO_0_1 [get_bd_ports SDO_0] [get_bd_pins ads8688_0/SDO]
  connect_bd_net -net ads8688_0_CS [get_bd_ports CS_0] [get_bd_pins ads8688_0/CS]
  connect_bd_net -net ads8688_0_RST [get_bd_ports RST_0] [get_bd_pins ads8688_0/RST]
  connect_bd_net -net ads8688_0_SCLK [get_bd_ports SCLK_0] [get_bd_pins ads8688_0/SCLK]
  connect_bd_net -net ads8688_0_SDI [get_bd_ports SDI_0] [get_bd_pins ads8688_0/SDI]
  connect_bd_net -net ads8688_0_outRMS [get_bd_pins ads8688_0/outRMS] [get_bd_pins axi_gpio_1/gpio_io_i]
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins ads8688_0/dataAddr] [get_bd_pins axi_gpio_0/gpio2_io_o]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins ads8688_0/rst_n] [get_bd_pins axi_gpio_0/gpio_io_o]
  connect_bd_net -net axi_gpio_3_gpio_io_o [get_bd_ports CTL] [get_bd_pins axi_gpio_3/gpio_io_o]
